...
#ifdef R_3_SHUNT
		// Configure AIO10 for ADC sampling (Motor Iu) and OC protection
		pac5xxx_tile_register_write(ADDR_CFGAIO0, (0x40 | (motor_ptr->app_amplifier_gain_register) << 3 | 0x03)); // AIO01: DiffAmp(0x40), X gain(<<3), LP COMP Enabled with 4us blanking(0x03)
		pac5xxx_tile_register_write(ADDR_CFGAIO1, (0x10 | 0x00 | 0x00));                            // AIO10: LPROT Enable(0x10), DiffAmp Offset Enable(0x08) , HP COMP Disabled(0x00)

		// Configure AIO32 for ADC sampling (Motor Iv) and OC protection
		pac5xxx_tile_register_write(ADDR_CFGAIO2, (0x40 | (motor_ptr->app_amplifier_gain_register) << 3 | 0x03)); // AIO23: DiffAmp(0x40), X gain(<<3), LP COMP Enabled with 4us blanking(0x03)
		pac5xxx_tile_register_write(ADDR_CFGAIO3, (0x10 | 0x00 | 0x00));                            // AIO32: LPROT Enable(0x10), DiffAmp Offset Enable(0x08) , HP COMP Disabled(0x00)

		// Configure AIO54 for ADC sampling (Motor Iw) and OC protection
		pac5xxx_tile_register_write(ADDR_CFGAIO4, (0x40 | (motor_ptr->app_amplifier_gain_register) << 3 | 0x03)); // AIO45: DiffAmp(0x40), X gain(<<3), LP COMP Enabled with 4us blanking(0x03)
		pac5xxx_tile_register_write(ADDR_CFGAIO5, (0x10 | 0x00 | 0x00));                            // AIO54: LPROT Enable(0x10), DiffAmp Offset Enable(0x08) , HP COMP Disabled(0x00)
#else
		// Configure AIO10 for ADC sampling (Motor Iu) and OC protection
		pac5xxx_tile_register_write(ADDR_CFGAIO0, (0x40 | (motor_ptr->app_amplifier_gain_register) << 3 | 0x03)); // AIO01: DiffAmp(0x40), X gain(<<3), LP COMP Enabled with 4us blanking(0x03)
		pac5xxx_tile_register_write(ADDR_CFGAIO1, (0x10 | 0x00 | 0x00));                            // AIO10: LPROT Enable(0x10), DiffAmp Offset Enable(0x08) , HP COMP Disabled(0x00)
...
void init_over_current_limit(uint32_t current_limit)
{
    ...
    pac5xxx_tile_register_write(ADDR_HPDACL, (uint8_t)((current_limit & 0x03)));       	// LB: 2b LSB
#else
    // Set LPROT protection threshold
    pac5xxx_tile_register_write(ADDR_LPDACH, (uint8_t)((current_limit >> 2) & 0xFF));   // HB: 8b MSB
    pac5xxx_tile_register_write(ADDR_LPDACL, (uint8_t)((current_limit & 0x03)));        // LB: 2b LSB
#endif
}
