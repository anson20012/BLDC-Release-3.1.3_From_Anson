...
//	pac5xxx_timer_io_select_pwma6_pa5();	// WH
	...
	pac5xxx_adc_as0_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_MSPI(ADC_SEQ_P_UIN_EDATA_REG), ASSEQ_DELAY_0); // ADC_SEQ_M1_IU_EDATA  (SIGMGR_AIO10 = 0)
	pac5xxx_adc_as0_sequence_config(1, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_MSPI(ADC_SEQ_P_VIN_EDATA_REG), ASSEQ_DELAY_0); // ADC_SEQ_P_UIN_EDATA_REG (SIGMGR_AB7 = 9)
	pac5xxx_adc_as0_sequence_config(2, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_MSPI(ADC_SEQ_P_WIN_EDATA_REG), ASSEQ_DELAY_0); // ADC_SEQ_P_WIN_EDATA_REG (SIGMGR_AB8 = 10)
	pac5xxx_adc_as0_sequence_config(3, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_MSPI(ADC_SEQ_VOUT_EDATA_REG), ASSEQ_DELAY_0);  // ADC_SEQ_P_WIN_EDATA_REG (SIGMGR_AB9 = 11)
	pac5xxx_adc_as0_sequence_config(4, VBUS_ADC_SAMPLE_CHANEL, ASSEQ_MSPI_AFTER_SH, SIGMGR_MSPI(ADC_SEQ_M1_IV_EDATA), ASSEQ_DELAY_0); //Vbus ADC voltage use PC3  (SIGMGR_AB4 =  )
	pac5xxx_adc_as0_sequence_config(5, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_MSPI(ADC_SEQ_M1_IW_EDATA), ASSEQ_DELAY_0);  // ADC_SEQ_M1_IV_EDATA  (SIGMGR_AIO54 = 2)
	pac5xxx_adc_as0_sequence_config(6, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_MSPI(ADC_SEQ_M1_IU_EDATA), ASSEQ_DELAY_0);  // ADC_SEQ_M1_IW_EDATA  (SIGMGR_AIO32 = 1)
#else
